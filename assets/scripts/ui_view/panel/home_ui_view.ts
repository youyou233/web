...
export default class HomeUIView {
	...
	initView(root : cc.Node) {
		...
		this.btnSetting = cc.find("content/nodeTop/btnSetting", root)?.getComponent(cc.Button)
		...
		this.btnScene = cc.find("content/nodeBtn/btnScene", root)?.getComponent(cc.Button)
